...
|------|-----------------|
| Lucas Rodrigues Alves | Líder — Arquiteto de Dados (DDL, DER, constraints, DQL, documentação) |
...
| Luigi Sapucaia de Lima | Desenvolvedor SQL (Triggers, DCL roles, manual de uso) |
...
Ou execute as SPs individualmente na ordem:
