...
-- ============================================================
-- As tabelas de staging são criadas e gerenciadas pelo script ETL:
--   02_etl/01_extract_staging.sql
-- Elas usam o schema dbo com prefixo stg_:
--   dbo.stg_cotacao, dbo.stg_indicadores_macro,
--   dbo.stg_dem_financeira, dbo.stg_cadastro_empresa,
--   dbo.stg_dividendos, dbo.stg_desdobramento
-- Execute o ETL após este DDL para criá-las automaticamente.
-- ============================================================
